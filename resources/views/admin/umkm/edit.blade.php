...
<div class="max-w-3xl">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-900">Edit Data UMKM</h1>
    </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="nama_usaha" id="nama_usaha" value="{{ old('nama_usaha', $item->nama_usaha) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6" required>
                            </div>
                            @error('nama_usaha')
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="pemilik" id="pemilik" value="{{ old('pemilik', $item->pemilik) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6" required>
                            </div>
                            @error('pemilik')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="kategori" id="kategori" value="{{ old('kategori', $item->kategori) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $item->telepon) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="email" name="email" id="email" value="{{ old('email', $item->email) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea id="alamat" name="alamat" rows="2" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6">{{ old('alamat', $item->alamat) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="url" name="website" id="website" value="{{ old('website', $item->website) }}" class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-blue-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium leading-6 text-slate-900">Foto Usaha Saat Ini</label>
                        <div class="mt-2 mb-4">
                            @if($item->foto)
                                <img src="{{ asset('storage/' . $item->foto) }}" alt="Preview" class="h-48 w-full object-cover rounded-lg border border-slate-200">
                            @else
                        ...
                        <label for="foto" class="block text-sm font-medium leading-6 text-slate-900">Ganti Foto (Opsional)</label>
                        <div class="mt-2">
